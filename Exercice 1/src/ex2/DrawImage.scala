...
class DrawImage(title: String) {
  ...
  def draw(nroIteration: Int): Unit = {
    var legend = Map.empty[String, Tuple3[Int, Int, Int]]
    vertices.foreach(arg => {
      configurePoint("", new Color(arg._2.color._1, arg._2.color._2, arg._2.color._3), arg._2.x, arg._2.y)
      legend += (arg._2.nom -> (arg._2.color._1, arg._2.color._2, arg._2.color._3))
    })

    var x = -250
    legend.foreach(arg => {
      configurePoint("", new Color(arg._2._1, arg._2._2, arg._2._3), x, 220)
      configureLabel(arg._1, x + 10, 220, 8)
      x += arg._1.length + 50
    })

    g.setColor(new Color(0, 0, 255)) // same as Color.BLUE
    g.draw(new Line2D.Double(-250, 210, 600, 210))
